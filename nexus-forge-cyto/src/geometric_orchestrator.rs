//! Geometric JSON coordinator: `(128,2)` contour envelopes -> kappa (64-pt) + spatial/tabular enrichment.
...
pub fn write_enriched_geometric_output(
    ...
    for i in 0..n_cells {
        ...
        // (Mojo/area Malignant from earlier step is preserved — not cleared.)
    }
